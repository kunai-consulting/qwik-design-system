...
`, async ({ page }) => {
    ...
    await expect(page.locator("span").first()).toHaveAttribute("data-from-comp");
  });
});
...
test.describe("Component", () => {
  ...
  test(`GIVEN a component that uses asChild
    ...
    await expect(page.locator("span").first()).toHaveAttribute("data-outside-comp");
    await expect(page.locator("span").first()).toHaveAttribute("data-inside-comp");
  });
});
