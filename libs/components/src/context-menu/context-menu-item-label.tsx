...
import { DropdownItemLabelBase, PublicDropdownItemLabelProps } from "../dropdown/dropdown-item-label";

/** Label component for context menu items */
export const ContextMenuItemLabelBase = component$<PublicDropdownItemLabelProps>((props) => {
  return (
