...
export function getSourceFile(path: string) {
  ...
  export function getLeadingComment(sourceFile: ts.SourceFile, node: ts.Node): string | undefined {
  ...
  export function parseComponentAnatomy(indexPath: string, componentName: string): AnatomyItem[] {
  ...
  export function parseSingleComponentFromDir(path: string, ref: SubComponents): SubComponents | undefined {
