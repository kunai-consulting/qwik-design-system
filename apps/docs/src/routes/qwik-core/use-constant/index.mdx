...
In Qwik Design System, this hook is used to determine which state persistence strategy. If the component is initially on the server, it will use a server side cookie, otherwise it will use localStorage