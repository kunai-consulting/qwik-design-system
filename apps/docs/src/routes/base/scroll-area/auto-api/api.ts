  ...
  "keyboardInteractions": [
    {
      "key": "ArrowDown",
      "comment":
        "Scrolls the viewport content vertically downward when focus is on the viewport"
    },
    {
      "key": "ArrowUp",
      "comment":
        "Scrolls the viewport content vertically upward when focus is on the viewport"
    },
    {
      "key": "ArrowRight",
      "comment":
        "Scrolls the viewport content horizontally to the right when focus is on the viewport"
    },
    {
      "key": "ArrowLeft",
      "comment":
        "Scrolls the viewport content horizontally to the left when focus is on the viewport"
    },
    {
      "key": "PageDown",
      "comment":
        "Scrolls the viewport content down by a larger increment when focus is on the viewport"
    },
    {
      "key": "PageUp",
      "comment":
        "Scrolls the viewport content up by a larger increment when focus is on the viewport"
    },
    {
      "key": "Home",
      "comment":
        "Scrolls to the top of the viewport content when focus is on the viewport"
    },
    {
      "key": "End",
      "comment":
        "Scrolls to the bottom of the viewport content when focus is on the viewport"
    },
    {
      "key": "Ctrl/Cmd + 0",
