...
export default component$(() => {
  ...
  return (
    <div class="space-y-4">
      <button onClick$={() => (isDisabled.value = !isDisabled.value)} type="button">
        Toggle Disabled
      </button>

      <RadioGroup.Root class="radio-group" disabled={isDisabled.value}>
        ...
        {[
          ...
          <RadioGroup.Item class="radio-group-item" key={plan.value} value={plan.value}>
