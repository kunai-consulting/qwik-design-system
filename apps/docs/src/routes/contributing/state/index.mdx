...
> **RECOMMENDED:** Use `useBindings` for component state management to ensure proper synchronization between internal state and consumer-provided values, while supporting both value-based and signal-based approaches.
